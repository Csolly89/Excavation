    ...
    return (
        ...
        <div className="overflow-hidden h-full -mt-10" >
            ...
            <div className="hidden md:inline ">
                <div className="relative z-10 md:top-[29vh] md:left-[8vw] lg:left-[23vw] lg:top-[42vh]">
                ...
                <img src={background} alt="backwoods cabin and roadway" className='shadow-2xl shadow-black relative rounded-2xl xl:mx-auto'/>
            </div>
            {/* mobile view */}
